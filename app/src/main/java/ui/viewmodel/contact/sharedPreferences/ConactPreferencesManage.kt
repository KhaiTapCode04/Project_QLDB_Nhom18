...
class ConactPreferencesManage(private val context: Context) {

    companion object {
        private const val PREF_NAME = "ContactPreferences"
    ...
    fun saveOrUpdateContact(contact: Contact) {
        ...
        sharedPreferences.edit()
            .putString(KEY_CONTACT_LIST, json)
            .apply()
    }
